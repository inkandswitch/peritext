 ...
 */
function opsToMarks(ops: Set<MarkOperation>): MarkMapWithoutOpIds {
...
export default class Micromerge {
    ...
    private applyAddRemoveMark(op: MarkOperation) {
        ...
        for (const [index, side, elMeta] of positions) {
            ...
            let patch, newOps
            [newOps, exitLoop, opIntersectsItem, partialPatch, patch] = this.applyOpToEachPosition(op, currentOps, side, elMeta, visibleIndex, partialPatch, length, opIntersectsItem)
    ...
    private applyOpToEachPosition(
        ...
        return [newOps, exitLoop, opIntersectsItem, partialPatch, patch]
    }
